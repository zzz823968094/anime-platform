...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='广告位配置表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='广告投放策略表';

-- 插入默认广告位数据
INSERT INTO `ad_position` (`position_code`, `position_name`, `description`, `display_type`, `width`, `height`,
                           `max_count`, `status`, `sort_order`)
VALUES ('SPLASH', '开机广告', '应用启动时显示的全屏广告', 'IMAGE', 1080, 1920, 1, 1, 1),
