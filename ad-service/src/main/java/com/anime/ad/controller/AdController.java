...
public class AdController {
    ...
    public Result getActiveAdsByPosition(@PathVariable String positionCode) {
    ...
    @PostMapping
    public Result createAd(@RequestBody AdDTO adDTO) {
    ...
    @PutMapping("/{id}")
    public Result updateAd(@PathVariable Long id, @RequestBody AdDTO adDTO) {
    ...
    public Result recordImpression(@PathVariable Long id) {
    ...
    public Result recordClick(@PathVariable Long id) {
