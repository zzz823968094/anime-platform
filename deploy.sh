...
show_deploy_info() {
    ...
    echo "  user-service          - 用户服务 (8081)"
    echo "  anime-service         - 动漫服务 (8082)"
    echo "  video-service         - 视频服务 (8083)"
    echo "  danmaku-service       - 弹幕服务 (8084)"
    echo "  crawler-service       - 爬虫服务 (8085)"
    echo "  admin-service         - 后台管理服务 (8086)"
    echo "  ad-service            - 广告服务 (8087)"
